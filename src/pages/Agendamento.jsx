...
const Agendamentos = ({ usuarioEmail }) => {
  ...
  const [form, setForm] = useState({
    ...
    telefone: '', 
    endereco: '',
    observacoes: '' // Adicionado para corrigir o vínculo duplo
  });
                ...
                {editandoId === item.id ? (
                  ...
                  <>
                    ...
                    <td className="p-4 md:p-5 align-top space-y-2 bg-blue-50/50 block md:table-cell">
                      ...
                      <textarea className="w-full border p-2 rounded text-sm" rows="2" value={itemEditado.observacoes} onChange={e => setItemEditado({...itemEditado, observacoes: e.target.value})} />
                  ...
                  <>
                    ...
                    <td className="p-4 md:p-5 align-top block md:table-cell">
                      ...
                      <div className="bg-slate-100 border-l-4 border-yellow-400 p-3 mb-3 shadow-sm">
                        <p className="text-[10px] font-bold text-yellow-700 uppercase mb-1">📝Observações:</p>
                        <p className="text-base font-bold text-red-800 leading-relaxed">{item.observacoes}</p>
                      </div>
